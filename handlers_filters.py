...
@chat.function("list_mail_folders", action_type="read",
               ...
               description=(
                   ...
                   "appear here. Use when user asks 'what folders do I have'."
               ))
